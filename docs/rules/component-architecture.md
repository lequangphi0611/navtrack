...
```
✅ Good
features/holdings/components/holding-table.tsx   (organism riêng feature)
components/ui/button.tsx                          (atom shadcn)
components/money-value.tsx                        (molecule dùng ở nhiều feature)

❌ Bad
components/holding-table.tsx   (chỉ holdings dùng mà đặt ở global)
features/holdings/components/button.tsx  (atom chung mà nhét vào feature)
```
...
// features/holdings/components/holding-list.tsx  (Server Component, không "use client")
