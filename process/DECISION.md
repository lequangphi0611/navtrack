...
- Docs đã sync: `docs/rules/e2e-page-object.md` (rule mới), `docs/coding-rules.md` (index), `docs/rules/testing.md` (mục End-to-end trỏ sang), `e2e/CLAUDE.md` (instruction scoped), `e2e/GOTCHAS.md` (nhật ký bẫy, seed từ bug thật đã gặp).
