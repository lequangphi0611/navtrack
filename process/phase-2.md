...
- [x] Job Python chạy theo lịch, ghi giá vào `PriceQuote`; app đọc để định giá — đã deploy `.github/workflows/price-fetcher.yml` (cron `30 9 * * 1-5`, secrets `DATABASE_URL`)
